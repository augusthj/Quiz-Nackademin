...
createQuestion(myQuestion[i].question, myQuestion[i].answer.a, 
    myQuestion[i].answer.b, myQuestion[i].answer.c, myQuestion[i].answer.d);
};
...
function createQuestion(questions, answer1, answer2, answer3, answer4) {
    ...
    label44.setAttribute("for",checkB4);
    label44.innerHTML = answer4;
    ...
    div_element.appendChild(checkB4);
    div_element.appendChild(label44);
...
function check(){
    ...
    if( checkB1.checked && checkB1.value == question[i].correctAnswer ){
        userCorrect += 1;
    }
